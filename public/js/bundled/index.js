...
},{"./login":"7yHem","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./mapBox":"k6XpQ","./updateSettings":"l3cGY","./stripe":"10tSC"}],"7yHem":[function(require,module,exports,__globalThis) {
...
const login = async (email, password)=>{
    try {
        ...
        if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'logged in successfully');
        window.setTimeout(()=>{
            location.assign('/');
        }, 1500);
        console.log(res);
...
const logout = async ()=>{
    try {
        ...
        (0, _alerts.showAlert)('error', 'Error, try again');
    }
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5","./alerts":"6Mcnf"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{"adfd9b103875c2dd":"c01Zm","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c01Zm":[function(require,module,exports,__globalThis) {
/*!
...
},{"5d2ce52638114663":"jFJg6","8970417cb9c0302c":"508P1"}],"jFJg6":[function(require,module,exports,__globalThis) {
'use strict';
...
},{}],"508P1":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports,__globalThis) {
'use strict';
...
/* eslint-disable */ // console.log('salam');
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const updateSettings = async (data, type)=>{
    try {
        ...
        (0, _alerts.showAlert)('err', err.response.data.nessage);
    }
};

},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"10tSC":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const stripe = Stripe('pk_test_51RbygcFNQBeexrUUBhjWAt4WZlq9mungUzeKlVW1eF2jvGFR8GYUcKKhzrlVLd9HY8tbk4PdUy2iHhN7ih9oxJTB00xaA0Iqay');
